...
import { createStudentPost } from "@/services/StudentPost";

const CreateStudentPostForm = () => {
  const form = useForm();
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    try {
      ...
      const res = await createStudentPost(postData);
  ...
  return (
    <div className="border-2 border-gray-300 rounded-xl flex-grow w-full p-5">
      <SectionTitle
        ...
        colorWord="Post"
        subtitle="Tell Us What You Want to Learn and Get Matched with a Tutor"
      />
...
export default CreateStudentPostForm;
